...
def clean_markdown_for_summary(md_text):
    ...
    for line in lines:
        ...
        elif not summary_parts and len(cleaned) > 10:
            summary_parts.append(cleaned)
...
def format_inline_markdown(text):
    ...
    text = re.sub(r'(?<!href=")(https://www\.google\.com/maps/search/\?api=1&query=[^\s\)]+|https://maps\.google\S+|https://maps\.app\S+|https://share\.google\S+)', r'<a class="map-link-inline" href="\1" target="_blank">地圖導航 📍</a>', text)
    return text
...
CUSTOM_SUMMARIES_V10 = {
    ...
    (1, "前往淺草橋飯店"): "<strong>搭乘首選（直達）：</strong>從羽田機場第3航廈站 搭乘「京急機場線 (直通都營淺草線)」直達 淺草橋站（A1 電梯出口）。車程約 40-45 分鐘，免提行李換車。",
    (1, "飯店 Check-in 與小歇"): "步行抵達海茵娜酒店辦理 Check-in、置放行李、稍作休息，更換舒適鞋衣。",
    ...
    (2, "尋找基地營咖啡廳與會合點"): "<strong>首選基地營：</strong><a class=\"map-link-inline\" href=\"https://maps.app.goo.gl/uX7kK5Wj9s6k1y8N7\" target=\"_blank\">☕ DEAN & DELUCA CAFE (PARCO_ya 1F) 🔗</a>（人均 ¥500-800）。<br><strong>備案基地營：</strong>喫茶 トリコロール (松坂屋本館 2F)（人均 ¥800-1,200），日系復古環境幽靜。",
    (2, "上午自由活動"): "<strong>室內組：</strong>在基地營悠閒放鬆或逛松坂屋百貨與 PARCO_ya 百貨。<br><strong>戶外組：</strong>松坂屋 ➔ 不忍池（賞荷花） ➔ 清水觀音堂（看月之松）。<br><strong>隱藏美食：</strong>順路步行至「兔屋 (うさぎや)」採買現做百年銅鑼燒。",
    ...
    (2, "下午自由活動"): "<strong>室內避暑亮點：</strong><a class=\"map-link-inline\" href=\"https://maps.app.goo.gl/J8q2bK6k8Y7u9N1P3\" target=\"_blank\">🏛️ 國立西洋美術館 🔗</a> 欣賞羅丹雕塑與莫內睡蓮（<strong>滿 65 歲長輩出示護照常設展免費入場</strong>，冷氣極強！）。隨後前往上野公園中央噴水廣場林蔭散步。",
    ...
    (2, "返回飯店"): "由御徒町搭乘山手線至秋葉原，轉總武線 1 站返抵淺草橋飯店，早點洗熱水澡放鬆休息。",

    # Day 2 Kids (Disney)
    (2, "親子組交通移動（輕鬆電車路線）"): "淺草橋 ➔ 秋葉原 (總武線) ➔ 八丁堀 (地鐵日比谷線) ➔ 舞濱 (JR京葉線)。全程設有手扶梯與電梯，避開東京車站巨型轉乘。",
    ...
    (2, "午餐"): "<strong>首選餐廳：</strong>紅心皇后宴會大廳（主題排餐，人均 ¥1,500-2,000）。<br><strong>🚀 免排隊神招 (Mobile Order)：</strong>提前預訂 <strong>廣場閣樓餐廳</strong>（漢堡排炸蝦拼盤）或 <strong>明日樂園舞台餐廳</strong>（炸雞漢堡），時間到直接取餐入座！",
    ...
    (3, "東京車站丸之內紅磚站舍（清晨散步與全家合影）"): "漫步丸之內站前開闊廣場，在清晨涼風中與百年壯麗紅磚建築合影。",
    (3, "跨越東西側前往一番街等待開門"): "<strong>🚨 避坑防刷卡指南：</strong>從丸之內（西側）跨越到八重洲（東側）時，<strong>請走站外的「北地下自由通路」</strong>！千萬別刷 Suica 誤進站！",
    (3, "東京車站一番街 (東京キャラクターストリート)"): "10:00 一開門優先逛：寶可夢商店（站長皮卡丘）、TOMICA 專賣店、吉伊卡哇商店、橡子共和國（龍貓）。",
    (3, "KITTE花園展望台 (屋上庭園 Kitte Garden)"): "搭電梯直達 KITTE 6F 屋頂花園，免費俯瞰東京車站紅磚站舍全景與新幹線進出站，室內空調充足。",
    (3, "午餐：天丼てんや (八重洲店)"): "<strong>首選餐廳：</strong><a class=\"map-link-inline\" href=\"https://maps.app.goo.gl/uX7kK5Wj9s6k1y8N7\" target=\"_blank\">🍤 天丼てんや 八重洲店 🔗</a> (八重洲地下街 南1號) 享用日式炸蝦天丼（人均 ¥560～¥850）。出餐極快、平價美味！<br><strong>備案 1：</strong>だし茶漬け えん KITTE丸の内店 (高湯茶泡飯，¥850-1,100)<br><strong>備案 2：</strong>燕子烤肉漢堡排 (大丸東京店 12F)",
    (3, "前往上野（JR 移動與避暑休憩）"): "搭乘 JR 山手線 8 分鐘直達上野站（公園口出站設有電梯）。",
    (3, "國立科學博物館 (国立科学博物館)"): "正午避暑勝地！參觀地球館 B1 恐龍化石骨骼、3F 野生動物標本展廳及 360 度球幕影院，冷氣充足放鬆。",
    (3, "離開國立科學博物館 ➔ 步行往御徒町方向"): "漫步穿越上野公園林蔭步道，前往御徒町阿美橫丁商圈。",
    (3, "點心 / 早晚餐：鴨 to 蔥拉麵 (らーめん 鴨to葱 御徒町本店)"): "<strong>首選名店：</strong>香濃鴨肉醬油拉麵（人均 ¥1,000～¥1,400）。<br><strong>🚨 排隊停損防雷規則：</strong>排隊 ≤ 3 組才吃，超過直接啟動阿美橫丁小吃備案，絕不在烈日下苦等！",
    (3, "阿美橫丁(アメ横)商圈採買"): "<strong>必掃名店：</strong><br>• 二木菓子（二木の菓子 第一営業所）：掃日本零食名產（Calbee、干貝糖）。<br>• OS Drug 上野店：藥妝免退稅價格之冠。<br>• 街邊小吃：肉之大山炸肉餅、みなとや章魚燒。<br>• 多慶屋（TAKEYA）：紫色商場一站式補貨備案。",
    (3, "返回淺草橋與收尾備案"): "搭電車返回淺草橋。若未吃拉麵，晚餐備案：吉野家 / 松屋 浅草橋店 / ろく月 雞白湯拉麵。",

    # Day 4
    (4, "前往三鷹（總武線 ➔ 中央線快速無縫平行轉乘）"): "淺草橋 ➔ 御茶之水 (總武線)。<strong>在御茶之水站「同月台正對面」無縫平行換乘</strong> JR 中央線快速直達三鷹站，省下 15 分鐘！",
    (4, "三鷹站 ➔ 吉卜力美術館接駁巴士"): "三鷹站南口 9 號公車站搭乘黃色龍貓彩繪接駁巴士（車程約 5 分鐘）。",
    (4, "三鷹之森吉卜力美術館 (三鷹の森ジブリ美術館)"): "參觀重點：龍貓售票亭 ➔ 貓巴士 ➔ 土星座短篇動畫 ➔ 屋頂天空之城巨神兵機械人。預約 10:00 第一梯次入場。",
    (4, "前往吉祥寺（Plan A 直達公車 / Plan B 林蔭散步）"): "<strong>首選 Plan A (防中暑公車)：</strong>美術館旁「萬助橋」站牌搭公車 5 分鐘直達吉祥寺站南口。<br><strong>備案 Plan B：</strong>走「井之頭恩賜公園」林蔭步道欣賞湖景。",
    ...
    (4, "晚餐：串家物語（DIY 炸串吃到飽）"): "<strong>首選餐廳：</strong><a class=\"map-link-inline\" href=\"https://maps.app.goo.gl/kX7m3Q8L9P2t4v8W9\" target=\"_blank\">🍢 串家物語 吉祥寺店 🔗</a> (ダイヤパレス吉祥寺 2F) 享用 DIY 炸串吃到飽（人均 ¥2,000～¥3,000）。<strong>建議 17:00 Hotpepper 線上預訂免排隊</strong>！<br><strong>備案：</strong>花丸烏龍麵 / 一風堂 吉祥寺店。",
    (4, "購買明日早餐麵包與返回淺草橋"): "外帶「Linde 德國麵包」或「Jyonetsu Bakery」人氣麵包當明日早餐。搭中央快速線至御茶之水同月台換總武線返回淺草橋。",

    # Day 5
    (5, "前往淺草"): "都營淺草線：淺草橋站 ➔ 淺草站 (直達僅 2 站 3 分鐘)。走 1 號或 3 號出口步行 1 分鐘即達雷門。",
    (5, "淺草寺 (浅草寺) & 雷門 (雷門) & 仲見世商店街 (仲見世商店街)"): "清晨人少漫步參拜：雷門大紅燈籠 ➔ 仲見世商店街 ➔ 寶藏門 ➔ 本堂祈福參拜。",
    (5, "展望台：淺草文化觀光中心 (浅草文化観光センター)"): "搭電梯直上 8 樓免費觀景台，俯瞰雷門、仲見世街紅色屋頂長廊與晴空塔全景，室內吹冷氣休憩。",
    ...
    (5, "晴空街道自由活動與高空景觀 (30F/31F)"): "逛寶可夢中心、橡子共和國、晴空塔限定紀念品；搭電梯至 30F/31F 免費展望長廊俯瞰東京市景。",
    ...
    # Day 6
    (6, "整理行李與辦理退房"): "整理行李辦理 Check-out，將全部大件行李免費寄放於海茵娜酒店櫃檯，輕裝出發。",
    (6, "前往築地場外市場"): "都營淺草線：淺草橋站 ➔ 東銀座站 (直達免轉車，僅 8 分鐘)。由 5 號或 6 號出口步行 3 分鐘即達築地。",
    (6, "築地場外市場 (築地場外市場)（尋味早餐與散策）"): "享用現做熱騰騰美食：<strong>「築地山長」現做玉子燒</strong>（¥150-200/份）、現烤海鮮、新鮮草莓大福。隨後參訪波除稻荷神社。",
    (6, "返回淺草橋酒店提取行李"): "東銀座搭都營淺草線 8 分鐘返抵淺草橋站，回海茵娜酒店櫃檯領取全部行李。",
    (6, "前往羽田機場（直通特急電車移動）"): "<strong>無障礙電梯進站：</strong>走淺草橋站 <strong>A1 出口無障礙電梯</strong> 直達月台，搭乘「機場快特 (直通京急線)」直達 羽田機場第3航廈站 (車程約 40-45 分鐘，免轉乘)。",
    (6, "辦理登機與羽田機場散策"): "起飛前 2.5 小時抵達第 3 航廈辦理登機與託運行李。逛江戶小路商場、觀景台看飛機起降。",
    (6, "午餐與最後免稅採買"): "管制區內享用平價定食/烏龍麵。於免稅店採買伴手禮（白色戀人、東京香蕉、Royce巧克力），14:00 前往登機門（CI221 14:30 起飛）。"
}

def clean_title(title_raw):
    t = re.sub(r'\[(.*?)\]\(.*?\)', r'\1', title_raw)
    t = re.sub(r'\([^\)]*maps[^\)]*\)', '', t)
    t = t.replace('✈️', '').replace('🚇', '').replace('🏨', '').replace('🍽️', '').replace('🏃', '').replace('🦕', '').replace('🌳', '').replace('🚌', '').replace('📸', '').replace('🍜', '').replace('🍪', '').replace('🛒', '').replace('⛪', '').replace('🌅', '').replace('🪙', '').replace('🎮', '').replace('🥞', '').replace('🍔', '').replace('🎡', '').replace('🏰', '').replace('🎢', '').replace('🎠', '').replace('🎆', '').replace('🛍️', '').replace('🚶‍♂️', '').replace('🐧', '')
    return t.strip()

def get_category_info(title):
    t_lower = title.lower()
    if any(x in t_lower for x in ['餐', '食', '吃', '拉麵', '燒', '飲', '咖啡', '麵', '丼', '牛舌', '丸子', '甜點', '泡芙', '銅鑼燒', '炸牛肉丸', '壽司', '文字燒', '麥當勞', '摩斯', '大戶屋', '串家物語', 'すき家', '宇奈とと', '天丼', '玉子燒']):
        return 'food', '美食', '🍜'
    elif any(x in t_lower for x in ['車', '航', '抵達', '交通', '公車', '地鐵', '捷運', '飛機', '前往', '返回', '機場線', '京急', '總武線', '山手線', '電車', '出發']):
        return 'transport', '交通', '🚆'
...
def parse_v10_markdown():
    ...
    if d1_match:
        ...
        # Parse slots
        slots = re.split(r'\n(###+ \*\*.*?)\n', d1_text)
        current_subplan = 'common_before'
        for i in range(1, len(slots), 2):
            h = slots[i]
            b = slots[i+1] if i+1 < len(slots) else ""
            h_clean = h.replace('###', '').replace('####', '').replace('**', '').strip()
            
            if 'Plan A' in h_clean:
                current_subplan = 'plan_a'
            elif 'Plan B' in h_clean:
                current_subplan = 'plan_b'
            elif '共同收尾' in h_clean:
                current_subplan = 'common_after'
            ...
            maps_links = re.findall(r'https://www\.google\.com/maps/search/\?api=1&query=[^\s\)]+|https://maps\.google\S+|https://maps\.app\S+|https://share\.google\S+', h_clean + " " + b)
            maps_link = maps_links[0] if maps_links else f"https://www.google.com/maps/search/?api=1&query={urllib.parse.quote(slot_title)}"
            
            summary = CUSTOM_SUMMARIES_V10.get((1, slot_title))
            if not summary:
                # check partial match
                for (d, t), s in CUSTOM_SUMMARIES_V10.items():
            ...
            days_data[1][current_subplan].append({
                'time': slot_time,
                'title': slot_title,
                'category': cat,
                'category_zh': cat_zh,
...
def main():
    ...
    with open('/home/owen/tokyo/itinerary.html', 'w', encoding='utf-8') as f:
        f.write(html_output)
    print("✅ Successfully built itinerary.html (PWA version V10)!")
