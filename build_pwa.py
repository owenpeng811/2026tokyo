...
CUSTOM_SUMMARIES_V10 = {
    ...
    # Day 2 Parents
    (2, "出發前往上野御徒町"): f"從淺草橋搭 JR 總武線至秋葉原，轉山手線 1 站至 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('JR 御徒町站 (御徒町駅)', '')}\" target=\"_blank\"><strong>御徒町站</strong> 🔗</a> 北口出站，過馬路直達松坂屋與 PARCO_ya。",
    (2, "晨間清涼戶外散步"): f"<a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('松坂屋 (松坂屋 上野店)', '')}\" target=\"_blank\">松坂屋 🔗</a> 出發 ➔ <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('不忍池 (不忍池 弁天堂)', '')}\" target=\"_blank\">不忍池 🔗</a>（賞荷花） ➔ <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('清水觀音堂 (清水観音堂)', '')}\" target=\"_blank\">清水觀音堂 🔗</a>（看月之松）。順路至 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('兔屋 (うさぎや)', '')}\" target=\"_blank\">兔屋 🔗</a> 採買現做百年銅鑼燒。",
    ...
    (2, "走回御徒町商圈"): f"<strong>這段主要是走路</strong>：博物館走回御徒町實走約 1.5 公里、長輩步速需 28 分鐘，雨天建議改搭 JR 山手線 1 站。抵達後可在 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('客美多咖啡 (コメダ珈琲店 上野広小路店)', '')}\" target=\"_blank\">客美多咖啡 🔗</a>、<a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('聖瑪克咖啡 (サンマルクカフェ 御徒町南口店)', '')}\" target=\"_blank\">聖瑪克咖啡 🔗</a> 或 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('松坂屋 (松坂屋 上野店)', '')}\" target=\"_blank\">松坂屋 8F 休憩所 🔗</a> 短暫歇腳。",
