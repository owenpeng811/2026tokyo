...
CUSTOM_SUMMARIES_V10 = {
    ...
    # Day 2 Parents
    (2, "前往上野／御徒町"): f"從淺草橋搭 🟡 JR 總武線 1 站至秋葉原，站內轉 🟢 JR 山手線往上野方向。<br><strong>☀️ 晴天</strong>：搭 1 站至 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('JR 御徒町站 (御徒町駅)', '')}\" target=\"_blank\"><strong>御徒町站</strong> 🔗</a> 北口出站，過馬路直達松坂屋與 PARCO_ya。<br><strong>☔ 雨天</strong>：多坐 1 站至 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('JR 上野站 (上野駅)', '')}\" target=\"_blank\"><strong>上野站</strong> 🔗</a> 公園口出站，正對上野恩賜公園，步行 12 分鐘直達東京國立博物館。",
