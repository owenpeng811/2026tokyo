...
CUSTOM_SUMMARIES_V10 = {
    ...
    (2, "松坂屋／PARCO_ya 逛街與下午茶"): f"先走 5 分鐘至 <a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('兔屋 (うさぎや)', '')}\" target=\"_blank\">兔屋 🔗</a> 買現做百年銅鑼燒（<strong>咖啡廳謝絕外食，帶回飯店吃</strong>）。<br><strong>🥇 首選：</strong><a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('客美多咖啡 (コメダ珈琲店 上野広小路店)', '')}\" target=\"_blank\">客美多咖啡 🔗</a>（沙發座，¥500-700）<br><strong>🥈 備案：</strong><a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('聖瑪克咖啡 (サンマルクカフェ 御徒町南口店)', '')}\" target=\"_blank\">聖瑪克咖啡 🔗</a>（¥400-650）<br><strong>🥉 免費：</strong><a class=\"map-link-inline\" href=\"{MASTER_NAV_MAP.get('松坂屋 (松坂屋 上野店)', '')}\" target=\"_blank\">松坂屋 8F/RF 休憩所 🔗</a>",
