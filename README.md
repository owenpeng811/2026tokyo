...
> 🎫 **票務狀態：免費入場**（本時段僅長輩組前往，滿 65 歲常設展免費，出示護照即可）
...
> 🎫 **票務狀態：免費入場**（本時段僅長輩組前往，滿 70 歲總合文化展免費，出示護照即可）
...
>     * **學生免票**：中小學生與高中生常設展「完全免費」（9 歲女兒與 7 歲兒子直接免費入場）。
...
>   * 💡 **用餐祕訣**：入座後由店員開鍋 ➔ 90 分鐘吃到飽，自行至吧檯夾肉串/蔬菜/麵糊 ➔ 桌上有「炸物時間圖卡」（肉類約 2-3 分鐘、蔬菜約 1 分鐘），照圖卡的時間油炸即可。  
