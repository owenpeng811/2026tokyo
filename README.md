...
> * ⏱️ **臨時決定要吃就插在 16:05－16:55**，後面全部順延 50 分鐘（阿美橫丁 16:55－18:40、18:50 進站、晚餐 19:20－20:20、20:20 回飯店）。
> * 💡 **點餐祕訣**：先於門口自動食券機買票 ➔ 入座後店員會拿出一塊「當月 3 種蔥」牌子問「3選2」，直接用手指號碼（例如：1 和 3）即可！

### **16:05－17:55 🛍️ 阿美橫丁逛街採買**
...
> 💡 **為何首選定食**：當日下午已排 SATOU 炸牛肉丸與晚餐串家物語炸串吃到飽，午餐選烤魚／野菜定食可平衡全天口味，長輩也較不易膩；備案的一風堂與大戶屋同在北口側，若客滿可步行 3 分鐘轉進，動線不中斷。
...
>
> 💡 **點餐與付款祕訣**：排隊時直接向櫃台以手指比出數量點購「**メンチカツ**」（每個 ¥350、一次 5 個以上每個 ¥330），付現後現場領取即可，全程僅需比數字，不需日語對話。
...
>
> * ⚠️ **球幕劇場（Dome Theater GAIA）需另外預約與加購票**：門票與入館券**分開計算**（成人加購約 ¥300、18 歲以下約 ¥100，常設展＋球幕套票成人約 ¥940），一場 25 分鐘、112 個座位，**建議入館後第一件事就是先去劃位**，否則常額滿。
> * ⚠️ **網路上多數文章仍寫「必看 ASIMO 機器人表演秀」，該展示已於 2022 年 3 月 31 日結束**（本田與未來館契約到期），現場已看不到，請以官網當期展示為準。
> * 💡 **樓層概念**：6F 球幕劇場｜5F 常設展「探索世界」（地球科學、天文、生物）｜3F 常設展「創造未來」（電子、物理，互動裝置最多，小孩最愛）｜7F 餐廳可眺望台場與東京鐵塔。
