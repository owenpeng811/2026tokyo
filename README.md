...
| **Day 4** | **午餐**：薩莉亞（義式輕食）<br>**下午茶**：SATOU（炸牛肉丸）<br>**晚餐**：串家物語（炸串） | **午餐**：大戶屋（定食）、一風堂（拉麵）、花丸烏龍麵（烏龍麵）<br>**點心**：天音（鯛魚燒）、小笹（最中）<br>**晚餐**：一風堂（拉麵）、花丸烏龍麵（烏龍麵） |
...
> * 首選餐廳：**薩莉亞 吉祥寺駅北口**（サイゼリヤ 吉祥寺駅北口）（コスモ吉祥寺 3F，北口步行約 1 分鐘）享用平價義式料理（推薦：ミラノ風ドリア 米蘭風焗烤飯 ¥300、バッファローモッツァレラのマルゲリータピザ 水牛起司瑪格麗特披薩、辛味チキン 辣味雞翅、小エビのサラダ 小蝦沙拉、田舎風ミネストローネ 鄉村蔬菜湯），人均約 ¥600～¥1,000。  
...
> * 🚧 **導航連結待補（重要）**：本店尚未取得經 Places API 查證的 Place ID，因此**內文暫無導航超連結**，PWA 卡片的「📍 導航」按鈕**暫時指向備案的大戶屋**（兩店同在北口側、相距約 150 公尺，不會走錯方向）。待補齊後需把 `places.json` 的 `4_午餐` 改指本店。
> * 💡 **點餐祕訣（全菜單有 4 位數編號）**：  
...
> * 吉祥寺名物，100% 國產牛，外酥內多汁。位置在哈莫尼卡橫丁北側約 50 公尺，往コピス吉祥寺方向順路經過。
> * 🍽️ **買 2～3 顆五人分食就好**：距離 17:00 的炸串吃到飽還有 2 小時，一人一口嘗味道即可。雖然買 5 個以上每個便宜 ¥20，但為了留胃口不必湊數。
> * 📌 規則：**若覺得太多人，就直接放棄。** 15:00 已過午餐尖峰，隊伍通常比中午短。
