...
> 🔒 **不可延誤：預約時間帶 17:30－17:45**。到店**立刻用「お客様番号」報到**再等叫號；逾時號碼會被釋出，且會壓縮 90 分鐘的用餐時間。
...
<details><summary>🍣 壽司郎完整攻略：報到、結帳、價格與必點（點擊展開）</summary>

> **① 到店報到（已用 LINE 預約）**
>
> 1. 進門找**受付案内台**（門口附近的大型觸控機台）。
> 2. 選 **「チェックイン（報到）」**，輸入 LINE 預約完成畫面上的 **「お客様番号」**（四位數字，在畫面正中央紅字）。**先把那個畫面調出來再進門**。
> 3. 機台印出**座席案内票**，上面有桌號（如 テーブル 15 / カウンター 3），**這張要留著結帳用**。
> 4. **預約時間是一個時間帶不是準點**（例：17:30－17:45），到店就先報到，接著等叫號。
> 5. **LINE 會在叫號前先推播通知**，所以報到後可以在附近稍等，不必一直盯著螢幕。
> * ✅ **5 人坐得下，不用擔心桌子太小**：壽司郎的**テーブル席（包廂式）是固定規格，桌子兩側各一張長椅、每邊坐 3 人，上限 6 人**；訂位系統是**每 6 人配一張桌**，所以申報 3 人或 5 人都是配到同一張。本店共 172 席。
> * ⚠️ **真正要確認的是座位「類型」**：拿到座席案内票時看清楚是 **テーブル**（桌子）還是 **カウンター**（吧檯）——吧檯席無法五人相連。若拿到吧檯席，拿這句給店員看：
>   > **5名です。テーブル席に変更できますか？**（我們 5 位，可以換成桌子的位子嗎？）
> * 💡 若店員說要等，接著問 **どのくらい待ちますか？**（要等多久？）

> **② 結帳（不用等店員數盤子）**
>
> 1. 吃完直接在**桌上平板點「会計（結帳）」**——盤數與金額系統已自動算好。
> 2. 拿**座席案内票**到門口收銀處，掃描票上條碼結帳。
> 3. 可用現金、信用卡、Suica 等交通系 IC、QR 行動支付。
> * ⚠️ **實際結帳方式依店舖而異**，官方未載明本分店是否為全自助；若現場沒有自助精算機，就照店員指示到櫃台結帳。

> **③ 價格：不用背盤子顏色，看平板就好**
>
> * 本店為**都市型店舗，一皿 ¥150 起**（官方店舖頁載明）。
> * ⚠️ **不建議背「黃150／紅210／黑290／白370」那套盤色對照表**：查官方菜單，本店品項價格從 **¥140 到 ¥780** 都有，並非乾淨的四色分級；而且**平板上每一項都直接標價（含稅）**，看平板最準。
> * 白皿為**變動價格（時價）**，不是固定 ¥370 起。

> **④ 8/20 正在檔期內的期間限定品項**（官方菜單，8/19～8/30）
>
> | 品項 | 價格（含稅） |
> | :-- | :-- |
> | 本鮪中とろ（黑鮪魚中腹） | **¥140** ← 比基本盤還便宜 |
> | あわび（鮑魚）1 貫 | ¥140 |
> | 天然赤えび（天然赤蝦） | ¥210 |
> | ハッカクとシマゾイ盛り合わせ | ¥310 |
> | 国産ほたて食べ比べ（國產帆立比較盤） | ¥390 |
>
> * ⚠️ 各品項**售完即止**，平板上找不到就是賣完了。

> **⑤ 值得點的常態品項**
>
> * **鮪魚系列**：漬鮪魚赤身（漬けまぐろ）、蔥花鮪魚軍艦（軍艦ねぎまぐろ）。
> * **貝類與蝦類**：生帆立（生ほたて）、赤蝦（赤えび）——同品質在台灣貴很多。
> * **台灣少見的青背魚**：醃鯖魚（生〆真さば）、竹莢魚（あじ）、炙燒鰈魚鰭邊（炙りえんがわ）。
> * **熟食與甜點**：鯛魚高湯拉麵（濃厚鯛だしラーメン）、焦糖布蕾冰淇淋（カタラーナアイスブリュレ）。

> **⑥ 一個常見的誤傳**
>
> * ❌ **壽司郎沒有「醋飯減半」可勾選**。能減飯量的是**平板上標註「(ミニしゃり)」的品項**，只有那些點得到。
> * 「シャリハーフ」是藏壽司、「半シャリ」是濱壽司的做法，**別家的規則不適用這裡**。
...
### **✅ Plan C（條件啟動：新宿都廳夕陽與夜景）**

> 🚨 **這不是預設方案，啟動代價是放棄 Plan A 的秋葉原**（拍貼機、夾娃娃、扭蛋）。那是小孩的行程，換成大人的夜景，出發前全家先講好。

> ✅ **三項全中才啟動，缺一就走 Plan A 或 B**：
>   1. **今晚天氣好**：18－21 時降水機率 ≤ 20%，或從飯店窗外看得到遠處大樓輪廓清晰。
>   2. **8/24 的都廳看不成**：8/24 傍晚預報**能見度 < 15 公里或降水機率 ≥ 40%**；**或**已決定把迪士尼改到 8/24（那樣都廳會落到 8/21，該晚能見度僅約 4 公里）。
>   3. **全員體力還行**：小孩在飛機上有睡、沒有人喊累。
>
> ⏱️ **中止點：17:55 前沒抵達都廳就放棄**，改走 Plan A／B。官方標示**入室常態要排 20～30 分鐘**，17:50 到才趕得上 **18:25 的日落**；趕不上就只剩夜景，不值得為此壓縮迪士尼日的睡眠。
>
> ⚠️ **共同收尾順延約 35 分鐘**：超市改 19:55－20:15、回飯店約 20:20。隔天 06:20 起床，仍睡得滿 8 小時。

#### **16:15－16:50 🚇 前往新宿西口**

> * 目標地點：[**JR 淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**JB20**，西口進站）
> * 於 [**JR 淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**JB20**） 搭乘 **🟡 JR 中央・總武線各停（JB）** 往 **中野（Nakano）／三鷹（Mitaka）** 方向，搭乘 **10 站** 直達 [**新宿站 (新宿駅)**](https://www.google.com/maps/search/?api=1&query=35.6895924,139.7004128&query_place_id=ChIJH7qx1tCMGGAR1f2s7PGhMhw)（**JB10**）（車程約 25 分鐘，**不用換車**）。
>   * 💡 **下一站防呆**：搭車後下一站應為 **秋葉原（Akihabara／JB19）**；若顯示 **兩國（Ryogoku／JB21）** 表示搭錯方向，請立即下車改搭對面月台。
>   * 🚉 **抵達月台**：各停停靠 **16 號月台**，下車後跟隨 **🟩 綠色「西口（West Exit）」** 指標由 **西改札** 出站。

#### **16:55－17:35 🍽️ 晚餐：麥當勞**

> * 首選餐廳：[**麥當勞 (マクドナルド 新宿西口店)**](https://www.google.com/maps/search/?api=1&query=35.6892366,139.6981928&query_place_id=ChIJj8aWGtGMGGARxgm4q3X9Rt4) (西新宿 1-17-1 宍戸大樓 2F-3F 座位區) 享用平價速食（推薦：日本限定蝦排堡、照燒豬肉堡、兒童快樂餐），人均約 ¥500～¥900。營業時間 6:00－23:00。
> * 🚶 **從新宿站走過去（約 200 公尺、3 分鐘）**：由**西改札**出站進入東西自由通路 ➔ 往**左（西口方向）**走，跟隨 **「京王モール」** 指標 ➔ 走到 **「地上4出口」** 上到地面，步行約 1 分鐘即達。
> * 💡 **點餐祕訣**：多語言觸控點餐機支援繁體中文，出餐約 3～5 分鐘。

#### **17:35－17:50 🚶‍♂️ 前往東京都廳**

> * 目標地點：[**東京都廳 (東京都庁)**](https://www.google.com/maps/search/?api=1&query=35.6893249,139.6918129&query_place_id=ChIJ_UlItvCNGGARP1NMx2sFsYg)（第一本廳舍）
> * 🚶‍♂️ **走地面，往西 700 公尺、約 10 分鐘**：出餐廳後沿 **ふれあい通り** 一路往西，全程幾乎平坦。麥當勞就在新宿站往都廳的直線上，**不必回頭**。
> * 🚨 **最後一段照官方指示走**（[東京都財務局 工事に伴うアクセス案内](https://www.zaimu.metro.tokyo.lg.jp/tochousha/goannai/koji-access/)，2026-06-25 更新）：**直行到「高架下」再左轉**，沿高架下前進——**左側是都議會議事堂與都民廣場，右側就是展望室入口**。現場一律以 **「展望室」** 指標為準。

#### **17:50－18:45 🌇 欣賞東京都廳南展望室夕陽與夜景**
...
> * 🎫 **免費入場**，由第一本廳舍 1 樓搭**展望室專用電梯**至 45 樓。
> * ✅ **8/20（週四）確定開放**：官方規定南展望室休室日為**每月第 1、第 3 個星期二**（8 月為 8/4 與 8/18），8/20 不在其中；官網公告區亦無 8 月臨時休室。
> * ⏰ **開室 9:30－22:00，入室截止 21:30**（南展望室），入場免費。
> * ⚠️ **官方標示入室常態要排 20～30 分鐘**，加上安檢，**17:50 抵達才趕得上 18:25 的日落**，能一次看到夕陽與入夜後的夜景。
> * ⏱️ **排隊超過 45 分鐘才放棄**（20～30 分鐘是正常的），改搭車回淺草橋走共同收尾——隔天是迪士尼日。
> * 💡 **出發前先查即時人潮**：官網「展望室の混雑状況」以**空きあり（0～5 分）／やや混雑（5～30 分）／混雑（30 分以上）**三色顯示；惡劣天氣臨時閉室會公告在 [東京都觀光官方 X @tocho_tenbou](https://twitter.com/tocho_tenbou)。
> * 🎹 **45 樓有免費鋼琴「都庁おもいでピアノ」**：南展望室開室日 **19:00－21:00** 開放彈奏，小孩會彈的話可以排隊上去彈一首（本行程 18:45 就下樓看光雕，想彈要改留在樓上）。
> * ⚠️ **務必去南展望室**：北展望室僅開放至 17:30，南展望室才到 21:30。

#### **19:00－19:15 🎆 觀賞都廳光雕投影秀**
...
> * ⚠️ **要在地面看，不是在展望室看**：影像投在第一本廳舍**東側外牆**，45 樓看不到。
> * ⏰ **看 19:00 這場，每場 15 分鐘**。當天場次為 **19:00／19:30／20:00／20:30／21:00／21:30**。
> * 🚨 **太晚就放棄**：若 19:00 沒趕上，最多等 **19:30** 那場；**19:30 也趕不上就直接回飯店**，不要再等下一場。
> * ⚠️ **8/20 是週四，平日片單**：PAC-MAN eats TOKYO、Aimer、孤獨搖滾青春 Complex 等；哥吉拉與寶可夢只有土日與假日才演。

#### **19:20－19:50 🚆 返回淺草橋（新宿出發）**

> * 目標地點：[**新宿站 (新宿駅)**](https://www.google.com/maps/search/?api=1&query=35.6895924,139.7004128&query_place_id=ChIJH7qx1tCMGGAR1f2s7PGhMhw)（**JB10**）
> * 於 [**新宿站 (新宿駅)**](https://www.google.com/maps/search/?api=1&query=35.6895924,139.7004128&query_place_id=ChIJH7qx1tCMGGAR1f2s7PGhMhw)（**JB10**） **13 號月台** 搭乘 **🟡 JR 中央・總武線各停（JB）** 往 **千葉（Chiba）** 方向，搭乘 **10 站** 直達 [**JR 淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**JB20**）（車程約 25 分鐘，**不用換車**）。

### **🛒 共同收尾行程（Plan A / Plan B / Plan C 適用）**
...
> * 目標地點：[**松屋 (松屋 上野浅草口店)**](https://www.google.com/maps/search/?api=1&query=35.712541,139.777373&query_place_id=ChIJm6bhuZ6OGGARPMoVjXV14NY)（[**JR 上野站 (上野駅)**](https://www.google.com/maps/search/?api=1&query=35.7141672,139.7774091&query_place_id=ChIJCwbTk56OGGARRJJPe22ziWw) **浅草口**出口對面約 108 公尺）——**這段是走去吃午餐，不是去搭車**。
> * 由清水觀音堂沿公園步道下行，往 **上野站浅草口（Asakusa Exit）** 方向走，實走約 **500 公尺、長輩步速 10 分鐘**。
> * 🚨 **全程不需要刷卡進閘門**：同一站刷卡進出會白付一次車費，還可能被閘門擋下要找站員處理。
> * 🌡️ **想避開曝曬可走站內（不用刷卡）**：由 **不忍口** 進入車站 **1 樓大廳**，沿大廳往 **正面玄關口** 方向直走即達 **浅草口**。JR 東日本官方構內圖確認**不忍口與浅草口之間是同一片改札外空間**（1 樓連續相通、無閘門阻隔），全程有空調。
...
> * 目標地點：[**松屋 (松屋 上野浅草口店)**](https://www.google.com/maps/search/?api=1&query=35.712541,139.777373&query_place_id=ChIJm6bhuZ6OGGARPMoVjXV14NY)（[**JR 上野站 (上野駅)**](https://www.google.com/maps/search/?api=1&query=35.7141672,139.7774091&query_place_id=ChIJCwbTk56OGGARRJJPe22ziWw) **浅草口**出口對面約 108 公尺）——**這段是走去吃午餐，不是去搭車**。
> * 沿來時路穿過上野公園往南走，目標是 **上野站浅草口（Asakusa Exit）**，約 **12 分鐘**。
> * 🚨 **不要走公園改札進站**：公園口在 **3 樓**且本身就是一道改札，刷卡進去等於白付一次車費；本段全程不需要刷卡。
> * ☔ **雨天避雨走法**：走到 **不忍口** 進入車站 **1 樓大廳（改札外、不用刷卡）**，沿大廳往 **正面玄關口** 方向直走到 **浅草口** 再出來，這段有屋頂也有空調。
> * ☔ 雨勢大時可在 1 樓大廳或アトレ上野稍作停留，午餐店 24 小時營業，不必趕。
...
> * 目標地點：[**都營 淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**A16**）**走 A3 出口進站**（沒帶大行李走 A3 最近）
> * **07:10－07:20 都營淺草線移動**：於 [**都營 淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**A16**） **1 號月台** 搭乘 **🌹 都營淺草線（A）** 往 **西馬込（Nishi-magome／A01）／羽田空港 方向**，搭乘 **2 站** 至 **人形町站（A14）**（車程約 3 分鐘）。
>   * 💡 **下一站防呆**：搭車後下一站應為 **東日本橋（Higashi-nihombashi／A15）**；若顯示 **藏前（Kuramae／A17）** 表示搭錯方向，請立即下車改搭對面月台列車。
> * **07:20－07:26 人形町站內轉乘**：**不用出站、不用重刷卡**——人形町的都營與東京 Metro 之間設有**乘換專用改札**，全程留在付費區內，標準轉乘時間約 **2 分鐘**。
> * **07:26－07:32 日比谷線移動**：於 **人形町站（H14） 1 號月台** 搭乘 **⚪ 東京 Metro 日比谷線（H）** 往 **中目黑（Naka-meguro／H01） 方向**，搭乘 **2 站** 至 八丁堀站（H12）（車程約 4 分鐘）。
>   * 💡 **下一站防呆**：搭車後下一站應為 **茅場町（Kayabacho／H13）**，再下一站即為 **八丁堀（Hatchobori）**。

<details><summary>🚶 兩處轉乘的精準動線與省力位置（點擊展開）</summary>

>   * 🚶‍♂️ **精準轉乘動線（人形町 淺草線↔日比谷線約 2 分鐘）**：下車後就近搭**上行階梯／手扶梯**到改札層 ➔ 上來後往**左後方**走，再**直走** ➔ 通過**「乘換專用改札」**（不是一般出口改札，刷卡通過即可、不會扣款出站）➔ 繼續**直走**即達日比谷線 **1 號月台**（中目黑方向）。
>   * 💡 **省力乘車位置**：搭都營淺草線時盡量待在**第 6 節車廂第 3 個車門**附近，下車即最靠近轉乘用的階梯。
>   * ⚠️ **別走出一般改札**：人形町地面出口（A1～A6）與這段轉乘無關，看到「出口」字樣就是走錯了，要找的是寫著**「日比谷線」**的乘換專用改札。
...
> 🔒 **不可延誤：17:00 開演，一天只有這一場**，全程約 45 分鐘，錯過就沒有第二次。
...
> 🔒 **不可延誤：18:15 開始卡位**。晚到就只剩後排視野，19:45 開演前不會再有位置。
...
> 🔒 **不可延誤：19:45 開演，一天只有這一場**，全長約 45 分鐘。
...
> 🔒 **不可延誤：20:55 開演，一天只有這一場**，也是當天最後一個節目。
...
>   3. 抵達秋葉原站後，轉乘 **🟡 JR 中央・總武線（JB）** 往 **千葉（Chiba／JB39） 方向**，搭乘 **1 站** 直達 [**淺草橋站 (浅草橋駅)**](https://www.google.com/maps/search/?api=1&query=35.6974952,139.7859834&query_place_id=ChIJr-AfyrOOGGARWBazD9OfYeg)（**JB20**）返抵飯店。
> * ⏰ **末班車底線（8/21 星期五實查）**：**舞濱 23:49 發車、00:32 抵達淺草橋，是當天最後一班回得了飯店的車**。再晚一班（00:01 發）京葉線雖然還有，但日比谷線與總武線已收班，會卡在中途等到隔天 04:33 才到。**21:40 出園離末班還有 2 小時，非常充裕。**

<details>
<summary>🚌 為什麼不搭高速巴士？（本行程用不到，點擊展開）</summary>

> 🚨 **結論：21:40 出園趕不上任何一班，本行程一律搭電車。**

> 📄 官方時刻表：[JR 巴士關東：東京～東京迪士尼度假區・新浦安 數位時刻表](http://time.jrbuskanto.co.jp/bk04090.html)｜[京成巴士：東京駅～東京迪士尼度假區・新浦安地區路線頁](https://www.keiseibus.co.jp/express-bus/90401-2/)

> **東京迪士尼樂園發車時刻（全日，平日與假日相同）**
>
> | 樂園發 | 東京駅著 | 秋葉原著 |
> | :---: | :---: | :---: |
> | **16:25** | 17:00 | **17:20** |
...
> | **20:15**（末班） | 20:50 | — |
>
> * ⏰ **末班是 20:15**，你們 21:40 出園時早就沒有車了。
> * 🚨 **而且直達秋葉原的全日只有 16:25 那一班**，其餘三班只到東京駅，到了還要再轉車。
> * 💡 **什麼情況才用得到**：若某次改成**傍晚就離園**（例如放棄 20:55 城堡投影秀、19:20 前出園），才有搭巴士的空間。乘車處為東巴士總站 **11 番のりば**（**不是 1 番**，1 番是新宿・池袋・吉祥寺線），現場排隊、前門上車刷 Suica。
</details>
...
🚶‍♂️ **出站指引**：**下月台後先不要出改札**，跟隨 **「グランスタ / GRANSTA」** 或 **「地下1階」** 指標下至 **B1F**，第一站就在改札內。

> ⏱️ **這段抓 30 分鐘**：飯店走到站 2 分 ＋ 淺草橋到秋葉原 2 分 ＋ **秋葉原轉山手線要上下樓約 5 分** ＋ 2 站 4 分 ＋ **東京站站內下到 B1F 約 5 分**，再加等車與找路緩衝。

### **09:20－10:00 🍬 GRANSTA 東京駅內伴手禮採買**

> * 目標地點：[**GRANSTA 東京 (グランスタ東京)**](https://www.google.com/maps/search/?api=1&query=35.6798702,139.7675145&query_place_id=ChIJoYwA2fuLGGARrTNyOELGyV8)（東京駅 **B1F 改札內**）
> * 🚨 **一定要趁現在逛**：GRANSTA 東京的精華區在 **JR 改札內（駅ナカ）**，你們此刻正持票在改札內，**逛完再出站就不用另外花錢**。若先出站再回頭進來，五個人要多付 **入場券 ¥150 × 5 ＝ ¥750**（IC「タッチでエキナカ」同價，限 2 小時內）。
> * 東京限定甜點與伴手禮集中在此，適合買送人的體面伴手禮；重量較重的零食大包裝留到稍後的菓子樂園再買。

> 📄 **伴手禮挑選參考文**：[東京車站伴手禮 TOP40 排行攻略文章（2026）](https://www.funliday.com/posts/2026-tokyo-station-omiyage-top40/)｜[MATCHA：東京車站伴手禮精選介紹文](https://matcha-jp.com/tw/4981)｜[Japaholic：東京車站必買伴手禮攻略文章](https://www.japaholic.com/tw/article/detail/824430)

<details><summary>🎁 送朋友用的三個推薦（效期都查證過，點擊展開）</summary>

> **🥇 首選：砂糖奶油樹** ｜ 📍 [**砂糖奶油樹 東京站店 (シュガーバターの木 HANAGATAYA東京店)**](https://www.google.com/maps/search/?api=1&query=35.6826509,139.7667352&query_place_id=ChIJH3OfXg2LGGARwbxnP4cqU5A)
>   * 📍 **1F 在來線改札內、新幹線南換乘口旁**。同品牌在站內另有 **B1F「スクエア ゼロ」** 等櫃位，**看到哪個先買哪個，商品一樣**。
>   * ⏳ **常溫 120 天**——三者中效期最長，最不怕放。
>   * 💴 7 個入約 **¥600**、14 個入約 **¥1,200**。
>   * 全粒粉穀物脆片夾白巧克力，金色紙盒包裝，體面但不貴氣，送朋友的安全牌。
>   * 🔗 [官方商品頁（看外觀）](https://www.sugarbuttertree.jp/sand.html)

> **🥈 次選：紐約完美起司** ｜ 📍 [**紐約完美起司 南通路店 (NEWYORK PERFECT CHEESE 東京南通路店)**](https://www.google.com/maps/search/?api=1&query=35.6803624,139.7666707&query_place_id=ChIJVXEPwPuLGGARRjynJ4y9nzM)
>   * 📍 **1F 改札內「南通路」**，**08:00 就開門**。
>   * ⏳ 約 **45 天**——帶回台灣還有一個多月，夠用。
>   * 💴 8 個入約 **¥1,000**。
>   * 高達起司蘭朵夏餅包白巧克力與切達起司棒，東京車站人氣第一，精緻度最高。
>   * 🔗 [官方網站（看外觀）](https://newyork-perfect-cheese.com/)

> **🥉 效期最長：東京 Suica 企鵝奶油夾心餅乾** ｜ 📍 [**銀之鈴 (銀の鈴)**](https://www.google.com/maps/search/?api=1&query=35.6811856,139.7673717&query_place_id=ChIJ9-LJdPyLGGARZeSwNOHJv3I)
>   * 📍 **B1F「銀の鈴」廣場周邊的甜點櫃位**。⚠️ 這項商品**沒有自己的店舖地標**，導航請認**銀之鈴**這個會合地標，到了再看周邊櫃位。
>   * ⏳ **約 180 天**，三者中最長。
>   * 💴 10 枚入 **¥972**。
>   * 東京車站限定，Suica 企鵝包裝走可愛路線，看收禮者喜好決定。
>   * 🔗 [JR 東日本官方商城（看外觀）](https://shopping.jreast.co.jp/)

> 🧭 **怎麼順利找到（重要，先看這段）**
>   * 🚨 **不要指望 Google Maps 在站內幫你導航**：東京車站雖然有室內圖層、可切換樓層，但**地下與站體內收不到 GPS**，藍點會亂飄，不會像路面那樣一步步帶路。**手機漫遊只解決上網，不會讓定位變準。**
>   * ✅ **正確做法是看車站指標**。東京車站的指標系統很完整，認這三個關鍵字就夠：
>     * **「銀の鈴 / Ginnosuzu」**（B1F 會合地標，Suica 企鵝餅乾在這區）
>     * **「南通路 / South Passage」**（1F，紐約完美起司在這條）
>     * **「グランスタ / GRANSTA」**（甜點櫃位集中區的總稱）
>   * 🗺️ 上面的導航連結請當成**「先在地圖上看清楚彼此的相對位置」**，實際走的時候抬頭找指標比看手機快。
>   * 🚶 **建議順序（省腳程）**：先在 **B1F 銀之鈴** 買 Suica 企鵝餅乾 ➔ 上 **1F** 走 **南通路** 買紐約完美起司 ➔ 沿 1F 往新幹線南換乘口方向買砂糖奶油樹。三處都在改札內，40 分鐘足夠。

> 🚨 **這幾樣效期太短，不要買來送人**：PRESS BUTTER SAND（**只有 7 天**）、東京ばな奈（約 7 天）、各式生菓子。自己當天吃可以，送人會來不及。

> ⚠️ **提著走的問題**：這裡買完要提到 **18:35** 回飯店才放得下，中間還有國立科學博物館與阿美橫丁。**早上建議只買不重的餅乾類**；想多買幾盒可以留到 12:20 的東京駅一番街再補。

</details>

### **10:00－10:10 🚶‍♂️ 出丸之內地下改札至站前廣場**

> * 🚶‍♂️ **步行動線**：
>   1. 逛完 GRANSTA 後，沿 B1F 跟隨 **「丸の内地下中央口 / 丸の内地下南口」** 指標走到改札。
>   2. **由丸之內側改札出站**（此時才刷卡出站），再沿指標上行至 1F。
>   3. 走出站體，正前方即為開闊的 **「丸之內站前廣場」**。

#### ☀️ **晴天方案**

### **10:10－10:45 📸 欣賞東京車站丸之內站舍建築**
...
### **10:45－11:00 🚶‍♂️ 移動至 KITTE**

> * 🚶‍♂️ **移動動線**：站前廣場正對面就是 [**KITTE丸之內 (KITTE丸の内)**](https://www.google.com/maps/search/?api=1&query=35.6797983,139.7648650&query_place_id=ChIJdUbpSvqLGGARCmbc6R7hZJ8)，穿越馬路即達（或由 B1F 地下通道進入，**無需過 JR 剪票口**）。進館後搭館內電梯或中庭手扶梯上至 6F。

### **11:00－11:20 🌇 KITTE頂樓花園眺望東京車站**

> 🔒 **不可延誤：11:00 才開放，本段只有 20 分鐘**。太早到上不去，太晚到會壓縮到 11:20 的移動時間。
...
> * ⚠️ **開放時間提醒**：週六 **11:00** 準時開放，請勿提早上樓——**這是本段順序這樣排的原因**，丸之內側的事情要留到 11:00 才做得完。
...
### **10:10－11:00 🛍️ KITTE 館內逛街避雨**

> * 目標地點：[**KITTE丸之內 (KITTE丸の内)**](https://www.google.com/maps/search/?api=1&query=35.6797983,139.7648650&query_place_id=ChIJdUbpSvqLGGARCmbc6R7hZJ8)（丸之內側，**由 B1F 地下通道直接進入、不必上到地面淋雨**）
> * 舊東京中央郵局改建，館內為日系選物、文具與雜貨，B1F 另有餐廳街（午餐備案的高湯茶泡飯就在這層）。
> * ☔ 雨天版跳過戶外的丸之內站舍與 6F 頂樓花園，改為全室內。
...
### **11:20－11:35 🚶‍♂️ 移動至八重洲地下街**

> 🌤️☔ **晴天雨天共用**：以下到午餐為止兩案相同。

> * 🚶‍♂️ **步行動線（全程免刷卡、不必上到地面）**：
>   1. 由 KITTE 搭館內電梯下至 **B1F**，進入地下通道。
>   2. **不要進 JR 剪票口**，先**沿地下街往北（丸之內北口方向）走**，找 **「北地下自由通路 (North Underground Passage)」** 指標。
>   3. 通道內跟著 **「八重洲方面 (Yaesu)」** 指標直走（直線通道，約 5 分鐘），看到 **「八重洲地下中央口」「東京駅一番街」** 指標代表走對了。
> * 🚨 **一定要先往北，不能直接往東橫切**：東京車站的**中央通路與南通路都在改札內**，沒有票走不過去。改札外能東西穿越的**只有北側**——**1F 北自由通路**與 **B1F 北地下自由通路**兩條，我們走地下這條（有冷氣、不必上到地面）。若改從中央或南側穿越，五個人要多付入場券 ¥150 × 5 ＝ **¥750**。
>
> 📸 【辨識：東京車站改札外能穿越的位置】
> ![東京車站平面圖，左側粉紅色縱向通道為北自由通路（八重洲・丸之內連絡通路），黃色區域為改札內](./assets/images/tokyo_station_north_free_passage_map.jpg)
>
> * ✔ **看圖重點**：
>   * 圖的**上方是八重洲側、下方是丸之內側、左邊是北側**。
>   * **黃色區域＝改札內**，中央通路與南通路都在裡面。
>   * **左側粉紅色縱向通道＝北自由通路**，改札外只有這條能東西穿越；我們走的 **B1F 北地下自由通路就在它正下方一層**，位置一樣。
> * 💡 **這是今天唯一一次穿越東京車站**：早上的 GRANSTA、站舍、KITTE 都在丸之內側一次做完，接下來的午餐與菓子樂園都在八重洲側，**不再折返**。
> * 🍱 **出通道後先往南走去吃午餐**：經過八重洲地下中央口（菓子樂園就在對面，等一下回來逛）後繼續往南至 **南1號** 的 [**天丼てんや (天丼てんや 八重洲店)**](https://www.google.com/maps/search/?api=1&query=35.6790668,139.7679772&query_place_id=ChIJzQEVm_yLGGAR1QSl3jr9CNU)，約 3 分鐘。

### **11:35－12:20 🍽️ 午餐：天丼Tenya**
...
>
> 💡 **備案 1 在 KITTE B1F**：若 11:00 逛完頂樓花園時大家已經餓了，可以不穿越車站、直接在 KITTE 樓下吃，吃完再走通路過去逛菓子樂園。
</details>

### **12:20－13:00 🍪 東京車站菓子樂園限定採買**

> * 目標地點：[**東京菓子樂園 (東京おかしランド)**](https://www.google.com/maps/search/?api=1&query=35.680931,139.7682387&query_place_id=ChIJESNWC_yLGGARctOSTpDcc8Q)（**八重洲地下中央口改札正對面，B1F 東京駅一番街**）
> * 江崎固力果、森永、卡樂比、亀田四大廠的現做限定品，各有獨立門市可試吃，動線單純。
> * 📖 **出發前預習**：[東京おかしランド完整攻略（台灣媽媽實地介紹）](https://linshibi.com/?p=45284)
> * 🚉 **買完直接搭車**：菓子樂園就在 **八重洲地下中央口改札正對面**，逛完轉身進站即可，**不用再走回頭路**。
> * 🛍️ **空手來、提著走**：先吃飯後採買，不必提著零食擠在店裡吃；重的大包裝零食留到這裡買，早上的 GRANSTA 則以送人的體面伴手禮為主。
...
### **16:10－16:35 🚶‍♂️ 前往阿美橫丁**

> * 目標地點：[**OS Drug 藥妝店 (OSドラッグ 上野店)**](https://www.google.com/maps/search/?api=1&query=35.7108985,139.7748721&query_place_id=ChIJAQB_jZ-OGGARLPaThjF_JIQ)（阿美橫丁北段第一站）
> * 🚶‍♂️ **步行避暑動線**：從科博館穿過上野站進入阿美橫丁北口，約 700 公尺（家庭步速約 15～20 分鐘），走中央通騎樓或商店街遮蔭處。
> * 🧭 **今天阿美橫丁一路由北往南逛，不折返**：北段（OS Drug、松本清、肉之大山）➔ 中段（中央大樓廁所）➔ 南段（みなとや、二木菓子）➔ 御徒町站搭車。**二木菓子的大包裝零食最重，排在最後買，離御徒町站只有 90 公尺。**
...
> * ⏱️ **要吃就排在逛完之後（17:25 起）**：本店在阿美橫丁**南段、緊鄰二木菓子**，正好是今天由北往南的終點，先逛完再吃不必折返。此時晚餐的吉野家取消，整批順延（19:05 進站、19:30 回飯店放戰利品）。
...
> ☀️ **晴天版路線與預估停留時間**（由北往南單向，不折返，共 80 分鐘）：
>
> | 時間 | 停留 | 地點 |
> | :-- | :-- | :-- |
> | 16:35－17:05 | 30 分 | OS Drug ＋ 松本清（兩家隔壁，先比價再決定在哪家結帳） |
> | 17:05－17:15 | 10 分 | 肉之大山（炸牛肉餅、可樂餅） |
> | 17:15－17:20 | 5 分 | 阿美橫丁中央大樓（B1F／2F 廁所） |
> | 17:20－17:30 | 10 分 | みなとや食品（大章魚燒、海鮮丼） |
> | 17:30－17:55 | 25 分 | 二木菓子（零食採買，含免稅手續） |

<details><summary>☔ 下大雨時的替代順序（點擊展開）</summary>

> 🚨 **阿美橫丁沒有拱廊、路面未鋪整，下雨會積水**——這點與有頂棚的吉祥寺完全不同，是商店街刻意保留黑市時代原貌的結果。
>
> 💡 **但店本身都是室內的**：OS Drug、松本清、二木菓子都有屋頂，淋雨的是**店與店之間約 500 公尺的移動**與**街邊小吃**。所以核心採買照樣做得到，只是不能慢慢逛。

> ☔ **中雨版**（露天曝露從 80 分鐘降到約 40 分鐘）
>
> | 時間 | 停留 | 地點 |
> | :-- | :-- | :-- |
> | 16:35－17:15 | 40 分 | 阿美橫丁**快掃**：OS Drug ➔ 二木菓子。**只進店、不逛街、不吃街邊** |
> | 17:15－17:35 | 20 分 | 阿美橫丁中央大樓 B1F 亞洲食品街（室內，順便上廁所） |
> | 17:35－18:15 | 40 分 | [**多慶屋 (多慶屋 TAKEYA1)**](https://www.google.com/maps/search/?api=1&query=35.7068257,139.7768298&query_place_id=ChIJrdKWej2PGGARePk-9rp1pos)（御徒町站旁，全室內） |

> 🚨 **大雨版：直接跳過露天段**
>
> * 從科博館走到上野站後**搭 🟢 JR 山手線 1 站至御徒町站**（¥150／人），出站直接進多慶屋，全程幾乎不淋雨。
> * ⚠️ 晴天時這一站不划算（省不到腳程又多兩次過閘門），**只有下大雨時才值得**。
> * **多慶屋一棟就能取代阿美橫丁的兩大採買**：**1F 零食**（取代二木菓子）、**3F 藥妝**（取代 OS Drug；合利他命 EX PLUS、EVE 止痛藥、若元錠都有，且**有藥師駐點**）。
> * 💳 **比 OS Drug 方便的地方**：多慶屋**可免稅（免稅櫃台在 TAKEYA1 3F）、可刷非日本發行的信用卡**；OS Drug 則是只收現金、不辦免稅。
> * ⏰ **沒有時間壓力**：TAKEYA1 營業至 **23:00**，B1－B2 的 Summit 超市開到凌晨 1 點。

> 💡 **多慶屋樓層**：TAKEYA1 — 1F 零食飲料酒類｜2F 生活與清潔用品｜3F 美妝藥品（含免稅櫃台）｜4F 大創百元｜B1－B2 Summit 超市。TAKEYA3（10:00－19:00）— 3F 手錶｜4F 精品服飾包包。
>
> 📄 **行前必讀介紹文**：[MATCHA：上野必逛商場多慶屋攻略，零食藥妝名牌一次買齊介紹文（2026）](https://matcha-jp.com/tw/24424)｜[多慶屋新館樓層動線建議與必買清單攻略文（2026）](https://mimigo.tw/takeya-coupon/)｜[多慶屋必買商品 12 選介紹文（2026）](https://tokyo.letsgojp.com/archives/328552/)
>
> 💳 **折扣券**：多家旅遊網站提供多慶屋折扣券（結帳前手機出示畫面即可，可與免稅併用），但**各券有效期不同**，出發前再確認當期是否有效，不要當成一定拿得到。
...
>
> **🎯 本趟指定採買清單**（連結為廠商官方商品頁，內有實物照片，可直接給店員看）
>
> **① 乾眼（缺油／蒸發型）**
>
> | 商品 | 為什麼推薦 |
> | :-- | :-- |
> | [**羅特 乾眼修護EX (新ロート ドライエイドEX)**](https://jp.rohto.com/namida-rohto/dryaid/) | **超高黏度、專門補淚液的「油層」以防蒸發**——正好對應「不只缺水、還缺油」那種乾，不是一般補水眼藥水 |
> | [**新淚之羅特 乾眼 (新なみだロートドライアイ)**](https://jp.rohto.com/namida-rohto/) | 備選。含**芝麻油**與最高濃度角膜保護成分，同樣針對淚液三層結構 |
>
> **② 綜合感冒藥**
>
> | 商品 | 為什麼推薦 |
> | :-- | :-- |
> | [**百保能 GOLD A 微粒 (パブロンゴールドA〈微粒〉)**](https://www.catalog-taisho.com/category/02/001/04515/) | 成人用。**7 種成分一次涵蓋鼻水、喉嚨痛、發燒、咳嗽**，台灣人回購率最高的一款；不敢吃粉可改 [**錠劑版 (パブロンゴールドA〈錠〉)**](https://www.catalog-taisho.com/category/02/001/04513/) |
> | [**百保能兒童系列 (パブロンキッズ)**](https://www.catalog-taisho.com/brand/pabron/) | **1 歲以上可用、草莓味、不含咖啡因**，不會影響小孩睡眠 |
>
> **③ 維他命 C**
>
> | 商品 | 為什麼推薦 |
> | :-- | :-- |
> | [**Hi-C 1000 (ハイシー1000)**](https://alinamin-kenko.jp/products/vitamin/hic_sen.html) | **單純高劑量維他命 C 1000mg**，顆粒可直接入口，全家都能吃 |
> | [**俏正美 亮妍C (チョコラBB ルーセントC)**](https://www.chocola.com/) | 維他命 C 600mg **＋ L-半胱胺酸 240mg ＋ B2／B6**，走美白淡斑取向，與上面那款用途不同 |
>
> **④ 這趟特別實用的**
>
> | 商品 | 為什麼推薦 |
> | :-- | :-- |
> | [**休足時間 足清爽貼片 (休足時間 足すっきりシート)**](https://www.lion.co.jp/ja/products/341) | **本趟最該買的一項**——Day 2 迪士尼站走一整天，睡前貼小腿或腳底，靠高含水凝膠與薄荷醇降溫消疲勞。網友公認的隱藏用法：**先冰過再貼**，夏天爽感加倍 |
> | [**ROIHI 穴位貼布 (ロイヒつぼ膏)**](https://www.nichiban.co.jp/general/health/stiff_shoulder/roihi/) | 50 元硬幣大小圓形貼布、**專貼穴位**，以溫感刺激促進患部血行，長輩肩頸腰用得上 |
> | [**新表飛鳴S (新ビオフェルミンS)**](https://www.biofermin.co.jp/products/s/) | **三種乳酸菌整腸**，連吃一週日本料理、小孩腸胃不適時的保險 |
> | [**Cabagin 胃藥 (キャベジンコーワα)**](https://www.kowa.co.jp/kowabrand/cabagin/) | 吃太飽、胃脹時用；本趟有壽司郎與串家物語兩場吃到飽 |
>
> * 🚨 **百保能 GOLD A 屬「指定第2類・指定濫用防止医薬品」**：購買有**數量限制（通常一次限一件）**，店員會確認用途，這是日本法規不是刁難。
> * ⚠️ **以上皆為日本市售成藥，請照包裝的年齡與劑量指示服用**；小孩用藥、長輩有慢性病或正在服藥者，**買前先問店員的藥師或登録販売者**。
> * 🧳 **帶回台灣有數量上限**：一般成藥每種以 **12 瓶／盒**為限、合計不超過 **36 瓶／盒**，出發前再確認現行規定。
> * 💡 **OS Drug 的藥品放在結帳櫃台後方、不在開架上**：直接把上面的商品頁照片給店員看最快，不必比手畫腳。
...
> 🔒 **不可延誤：全預約制、票上印有指定入場時段**，遲到可能無法入場，且門票不退不換。
...
> * ☔ **下雨也能逛，但進巷前先收傘**：橫丁本身有拱廊頂棚，旁邊的 [**吉祥寺 Sunroad 商店街 (吉祥寺サンロード商店街)**](https://www.google.com/maps/search/?api=1&query=35.7038362,139.5798441&query_place_id=ChIJ8VJw6UfuGGARipDI2iZLP9o) 更是全長 300 公尺的全覆蓋拱廊，下午在北口商圈幾乎不會淋到。但**橫丁巷子只有 2～3 公尺寬**，撐傘會刮到店家與其他人；地面不平，雨天會積水。
...
> * 🚻 **橫丁裡沒有廁所**：巷弄只有兩三公尺寬、店家都是小攤位，不外借洗手間。**14:20 進橫丁前，先在午餐的薩莉亞（コスモ吉祥寺 3F）上完**；下午到晚餐前這段（14:20－17:00）都在吉祥寺北口商圈，商場廁所免費且不需消費：
>   * 🥇 [**Coppice 吉祥寺 (コピス吉祥寺)**](https://www.google.com/maps/search/?api=1&query=35.7049541,139.5795709&query_place_id=ChIJB0eQ1EfuGGARaKthmgoKqwU)（橫丁北側步行約 2 分鐘）：各樓層皆有廁所，**A 館 5F 另有親子廁所與哺乳室**。15:20 的 THANK YOU MART 與無印良品都在館內，本來就會進來。
>   * [**東急百貨 吉祥寺店 (東急百貨店 吉祥寺店)**](https://www.google.com/maps/search/?api=1&query=35.7050678,139.5777986&query_place_id=ChIJhxa9k0juGGARrLLZkBu09Ac)（橫丁**西**側）：從橫丁另一頭出來時走這家最近。
>   * [**吉祥寺 Loft (吉祥寺ロフト)**](https://www.google.com/maps/search/?api=1&query=35.705206,139.5788868&query_place_id=ChIJ80-AKEbuGGARmN-6SihPfpU)：15:50－16:30 自由活動若來這裡，館內也有。
>   * ⚠️ 上述商場 **10:00～10:30 才開門**，但你們下午才到，不受影響。
>   * 🕛 **24 小時備援**：[**武藏野市營公廁 (ミカレットきちじょうじ)**](https://www.google.com/maps/search/?api=1&query=35.7023874,139.5803008&query_place_id=ChIJl9bFUVTvGGARA5iIBLZOoxA) 全天開放，但**位於車站南口、要穿過車站**，下午動線都在北口，只在商場都關門時才用得到。
...
> 📄 **行前必讀介紹文**：[MATCHA：自己動手炸！90 分鐘串炸吃到飽連鎖店「串家物語」介紹文（繁體中文）](https://matcha-jp.com/tw/4214)

> 🔒 **不可延誤：17:00 已訂位，且吃到飽採 90 分鐘制、從入座起算**——遲到扣的是自己的用餐時間。
...
> 🔒 **不可延誤：餵食秀是固定時刻**——13:00 花園鰻、13:30 企鵝、14:00 珊瑚礁魚、14:30 小笠原大水槽。晚進場就會少看幾場，完整時刻表見下方摺疊。
...
>   * 🚶‍♂️ **精準動線**：從御茶之水往高尾方向的中央線快速，停靠 **11／12 號月台**（**7／8 號月台是反方向、開往東京的**，不要跟著走）。下車後**不要亂走**，抬頭找 **「西改札（West Gate）」** 指標下樓至 **B1F** ➔ 由 **西改札**出站，即進入 **東西自由通路**，可通往西口地下街與地面西口商圈。
>   * 🚉 **下車後往哪一端走**：通往 **B1F 東改札・西改札** 的樓梯與電梯在月台的**三鷹・八王子（高尾）那一端**，也就是**列車行進方向的前方**。上車時盡量待在**列車前段（約 9～12 號車廂）**，下車後往前走幾步就到，不必走完整條月台。
>   * ♿ **長輩電梯**：11／12 號月台下到 B1F 後，**西改札正對面就是 L 號電梯**。
>
> 📸 【辨識：JR 新宿站 B1F，11／12 號月台下樓後的位置關係】
> ![JR 新宿站 B1F 構內圖，11／12 號月台的樓梯與手扶梯下到 B1F 後，左側即為西改札與東西自由通路](./assets/images/shinjuku_b1f_west_gate.jpg)
>
> * ✔ **看圖重點**（JR 東日本官方構內圖，2026 年 8 月版）：
>   * 圖中央標 **「11, 12番線へ」** 的樓梯與手扶梯，就是你下車後要走的方向。
>   * 往**左**走到底的黃色標籤 **「西改札」** 就是出口，旁邊 **L** 是電梯。
>   * 出改札後那條**淺黃色縱向通道＝東西自由通路**（改札外）。
...
> * 首選餐廳：[**麥當勞 (マクドナルド 新宿西口店)**](https://www.google.com/maps/search/?api=1&query=35.6892366,139.6981928&query_place_id=ChIJj8aWGtGMGGARxgm4q3X9Rt4) (西新宿 1-17-1 宍戸大樓 2F-3F 座位區) 享用平價速食（推薦：日本限定蝦排堡、照燒豬肉堡、兒童快樂餐），人均約 ¥500～¥900。營業時間 6:00－23:00、120 席。  
>   * 💡 **點餐祕訣（全繁體中文自動點餐機）**：多語言觸控點餐機支援繁體中文，出餐約 3～5 分鐘。  
> * 🚶 **從新宿站走過去（約 200 公尺、3 分鐘）**：
>   1. 由 **西改札** 出站，進入東西自由通路。
>   2. 往**左（西口方向）**走，跟隨 **「京王モール」** 指標。
>   3. 走到 **「地上4出口」** 上到地面，出來步行約 1 分鐘即達。
> * 💡 **這家不繞路**：它就在新宿站往東京都廳的直線上（距車站約 200 公尺、距都廳約 580 公尺），吃完**繼續往西走就是都廳**，不必回頭。
> * ⚠️ **新宿西口施工中（至 2026 年 12 月）**：舊小田急百貨店拆除工程進行中，地下與地面動線不定期變更（已知 11 番階梯封閉、改走臨時階梯）。若當天「地上4出口」不通，**由任一西口上到地面往西走即可**，不會走丟。
...
> * 目標地點：[**東京都廳 (東京都庁)**](https://www.google.com/maps/search/?api=1&query=35.6893249,139.6918129&query_place_id=ChIJ_UlItvCNGGARP1NMx2sFsYg)（第一本廳舍）
> * 🚶‍♂️ **走地面，往西 700 公尺、約 10 分鐘**：出餐廳後沿 **ふれあい通り** 一路往西，全程幾乎平坦、無上下坡。麥當勞就在新宿站往都廳的直線上，**不必回頭**。
>   * 🚨 **最後一段照官方指示走**（[東京都財務局 工事に伴うアクセス案内](https://www.zaimu.metro.tokyo.lg.jp/tochousha/goannai/koji-access/)，2026-06-25 更新）：**直行到「高架下」再左轉**，沿高架下前進——**左側是都議會議事堂與都民廣場，右側就是展望室入口**。⚠️ **不要照舊攻略「看到都廳就直接穿越廣場」**，中央通り一帶動線已受施工限制，現場一律以 **「展望室」** 指標為準。

<details><summary>☔ 下雨或太熱時：改走地下道（點擊展開）</summary>

> * 路線為 [**新宿西口地下通路 (新宿副都心4号街路地下道)**](https://www.google.com/maps/search/?api=1&query=35.6905813,139.6942589&query_place_id=ChIJ7Y19XNSMGGARHj_BMBTDfIg)，**直線 303 公尺、全程空調、無岔路**，天花板懸掛 **「東京都庁方面」** 指示牌。
> * ⚠️ **從麥當勞過去要先往北繞**：這條地下道的東端接的是**新宿站西口地下廣場**，位置比麥當勞偏北。走地面只要 700 公尺，改走地下道會多繞一段，**只有下雨或酷熱時才划算**。
> * 🚶 **電動步道要走南側（左手邊）**：北側 **10:00－19:00 是往新宿站方向**，17:35 過去會逆向；南側 **9:00－18:00 固定往都廳方向**。往西走時南側在**左手邊**。改札外設有顯示方向的電子看板，可先確認。
> * 💡 **若當天改成不出地面用餐**：從 JR 新宿站 **西改札**出站後可直接由地下前往，全程不必上到地面（西改札至都廳第一本廳舍入口約 10 分鐘）。
...
>
> 🔒 **不可延誤：最慢 17:50 要抵達展望室**——8/24 **日落約 18:21**，要在同一趟看到**夕陽＋入夜後的夜景**，就必須趕在日落前上去。而且 **18:30－19:30 是安檢尖峰**，可能排 30 分鐘，17:50 抵達是刻意早於它。**晚到不是看不到夜景，是看不到夕陽**。（下方的光雕投影秀每半小時一場，晚一場也能看，那段不必趕。）
...
> * ⏰ **18:45 搭電梯下樓**：接著到地面的都民廣場看光雕投影秀，見下一段。**光雕每半小時一場（19:00／19:30／20:00／20:30／21:00／21:30），這裡多待一會也沒關係，改看下一場即可。**
...
#### **15:30－16:20 🤖 參觀千葉工大晴空塔城校區**

> 📄 **行前必讀介紹文**：[千葉工業大學晴空塔校區兩大展區與免費入場介紹文（繁體中文）](https://thegate12.com/tw/spot/1203)｜[聯合新聞網：東京體驗園區巡禮，感受日本機器人魅力介紹文](https://udn.com/news/story/9650/8246839)

> 🎫 **票務狀態：免費入場**

> * 目標地點：[**千葉工業大學晴空塔城校區 (千葉工業大学 東京スカイツリータウンキャンパス)**](https://www.google.com/maps/search/?api=1&query=35.7100881,139.8126847&query_place_id=ChIJf__tZNKPGGARHmHIRs1s3Mw) (東京ソラマチ 8F)
> * 🎫 **免費入館**，10:30－18:00。
> * 🤖 **展區 I 機器人**：災害應變機器人、探測機器人 Raptor、超大型機器人螢幕。
> * 🚀 **展區 II 太空**：**「隼鳥二號」實物大模型**、人造衛星、隕石實物、300 吋宇宙劇院。
> * ⚠️ 官方標示「不定休」，出發前看[官網](https://cit-skytree.jp/)確認當日開館。已知 9/24 與 12/7 維護休館，8 月無公告休館日。

#### **16:20－17:10 📮 參觀郵政博物館**

> 📄 **行前必讀介紹文**：[東京官方觀光網站 GO TOKYO：郵政博物館介紹文（繁體中文）](https://www.gotokyo.org/tc/spot/903/index.html)
>
> 🔗 官方網站（非中文）：[郵政博物館 官方網站](https://www.postalmuseum.jp/)

> 🎫 **票務狀態：需購票**

> * 目標地點：[**郵政博物館 (郵政博物館)**](https://www.google.com/maps/search/?api=1&query=35.7101874,139.8125818&query_place_id=ChIJ10y4FNaOGGARnQ23USYY0Ik) (東京ソラマチ 東館 9F)
> * 🎫 **入館料**：大人 ¥300、中小學生 ¥150，五人約 ¥1,200。開館 10:00－17:30，**入館受付至 17:00**。
> * 🎮 **可動手玩的展品**：機車送信模擬機 **「Go!Go! ポストマン」**、儲金與保險闖關遊戲「ゆうちょ・かんぽアドベンチャー」。
> * 📮 館藏郵票約 33 萬種。
> * ✅ **8/24 開館**：官方 2026-08-07 公告的 8～12 月休館日中，**8 月整月無休館日**。

#### **17:10－17:45 🛍️ 晴空街道商場採買**
...
#### **17:45－18:45 🍽️ 晚餐：宮武讚岐烏龍麵 / 一風堂 / 松屋**
...
> 🔒 **不可延誤：15:00 變身秀，請 14:55 前站到立像正前方**。白天場次為 11:00／13:00／15:00／17:00，本時段就是為了卡 15:00 這場；**展示於 2026 年 8 月底結束，這是最後一次機會**。
...
### **16:55－17:50 🛃 入境通關與提領行李**

> * **16:55** 班機降落台北松山機場 (TSA) 國際線航廈。  
> * 入境查驗 ➔ 提領行李 ➔ 海關，**抓 55 分鐘**。松山機場國際線的常見經驗是「連提領行李約需 1 小時」；五個人要等全部行李到齊，不要抓太緊。  
> * 💡 **有辦自動通關的人先過**，先去行李轉盤等，其餘人隨後會合。

### **17:50－19:20 🚗 專車接機：返抵住家**

> * 出關後搭乘預約專車直接返回住家，**車程約 90 分鐘**。  
> * ⚠️ **8/25 是週二、正好卡在平日傍晚尖峰（17:00－19:00）**：國道 3 號的**中和－土城－三鶯**路段是這個時段的常態壅塞區，離峰只要 62 分鐘的路程會被拉長，行程已按 90 分鐘估算。  
> * ⏱️ **預計 19:00－19:20 抵達住家**；若通關順利、路況良好可提早，但請以此為規劃基準。
