...
# Allow whitelist for non-physical non-nav metadata (like Day headings, estimated budgets, meal item labels, flight numbers)
metadata_whitelist = ["Day ", "迪士尼預估旅費", "建議購買", "行程總覽", "月台", "列車", "うな丼", "うな重", "套餐", "定食", "CI220", "CI221", "搭機返台", "TSA", "HND"]
