...
# Allow whitelist for non-physical non-nav metadata (like Day headings, estimated budgets, meal item labels)
metadata_whitelist = ["Day ", "迪士尼預估旅費", "建議購買", "行程總覽", "月台", "列車", "うな丼", "うな重", "套餐", "定食"]
