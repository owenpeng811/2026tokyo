...
nav_dict["東京迪士尼樂園東巴士總站 (東京ディズニーランド・バスターミナル・イースト 1番のりば)"] = "https://www.google.com/maps/search/?api=1&query=35.6364946,139.8807661&query_place_id=ChIJ3w8y8xN9GGARe5_gvaqDCMo"
nav_dict["東京迪士尼樂園東巴士總站 1 號站牌 (東京ディズニーランド・バスターミナル・イースト 1番のりば)"] = "https://www.google.com/maps/search/?api=1&query=35.6364946,139.8807661&query_place_id=ChIJ3w8y8xN9GGARe5_gvaqDCMo"
...
>   * **乘車地點**：出園剪票口後往右前方步行約 2 分鐘，至迪士尼樂園正門外「東巴士總站東面（Bus Terminal East）」[**東京迪士尼樂園東巴士總站 1 號站牌 (東京ディズニーランド・バスターミナル・イースト 1番のりば)**](https://www.google.com/maps/search/?api=1&query=35.6364946,139.8807661&query_place_id=ChIJ3w8y8xN9GGARe5_gvaqDCMo)（地面與立柱有明顯標示「1番：秋葉原駅行」）。  
...
for fname in ['README.md', '2026東京親子自由行_V10_Henna.md']:
    ...
    # Replace Day 2 return transit section
    content = re.sub(
...
print("Updated Bus Terminal East photo and details in both Markdown files!")
